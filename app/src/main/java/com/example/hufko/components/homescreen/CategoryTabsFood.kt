...
fun PastryCategoryPage() {
    Column(
        ...
        // Filter Button
        val pastryFilters = FilterConfig(
            filters = listOf(
                // Main filter dropdown
                FilterChip(
                    id = "filters",
                ...
                // PASTRY TYPES (with icons for popular types)
                FilterChip(
                    id = "croissant",
                    text = "Croissant",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_croissant
                ),
                FilterChip(
                    id = "danish",
                    text = "Danish",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_danish
                ),
                FilterChip(
                    id = "eclair",
                    text = "Éclair",
                ...
                // FLAVORS (with icons for popular flavors)
                FilterChip(
                    id = "chocolate",
                    text = "Chocolate",
                    type = FilterType.WITH_LEFT_ICON,
                ...
                // OCCASIONS (with icons for common occasions)
                FilterChip(
                    id = "snack",
                    text = "Snack",
                    type = FilterType.TEXT_ONLY
                ...
                // ORIGIN (with icons for major origins)
                FilterChip(
                    id = "american",
                    text = "American",
                    type = FilterType.TEXT_ONLY
...
fun PavBhajiCategoryPage() {
    Column(
        ...
        // Filter Button
        val pavBhajiFilters = FilterConfig(
            filters = listOf(
                // Main filter dropdown
                FilterChip(
                    id = "filters",
                ...
                // BHAGI TYPES (with icons for popular types)
                FilterChip(
                    id = "classic_pav_bhaji",
                    text = "Classic",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_classic
                ),
                FilterChip(
                    id = "cheese_pav_bhaji",
                    text = "Cheese",
                ...
                FilterChip(
                    id = "mushroom_pav_bhaji",
                    text = "Mushroom",
                    type = FilterType.TEXT_ONLY
                ),
                FilterChip(
                    id = "khada_masala_pav_bhaji",
                    text = "Khada Masala",
                    type = FilterType.TEXT_ONLY
                ),
                ...
                // PAV TYPES (with icons for pav variations)
                FilterChip(
                    id = "plain_pav",
                    text = "Plain Pav",
                    type = FilterType.TEXT_ONLY
...
fun SamosaCategoryPage() {
    Column(
        ...
        val samosaFilters = FilterConfig(
            filters = listOf(
                FilterChip(
                    id = "filters",
                    text = "Filters",
                ...
                FilterChip(
                    ...
                    text = "Potato",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_potato_samosa
                ),
                FilterChip(
                    id = "paneer_filling",
                    text = "Paneer",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_paneer_samosa
                ),
                FilterChip(
                    id = "chicken_filling",
                    text = "Chicken",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_chicken_samosa
                ),
                FilterChip(
                    id = "keema_filling",
                    text = "Keema (Minced Meat)",
                ...
                FilterChip(
                    ...
                    text = "Deep Fried",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_fried_samosa
                ),
                FilterChip(
                    id = "baked",
                    text = "Baked",
                    type = FilterType.WITH_LEFT_ICON,
                    icon = R.drawable.ic_baked_samosa
                ),
                FilterChip(
                    id = "air_fried",
                    text = "Air Fried",
        ...
        val samosaItems = listOf(
            FoodItemDoubleF(
                id = 1,
                imageRes = R.drawable.classic_samosa_1,
                title = "Classic Aloo Samosa",
                price = "₹40",
                restaurantName = "Bengal Sweet House",
                rating = "4.8",
                deliveryTime = "10-15 mins",
                distance = "0.5 km",
                discount = "20%",
            ...
            FoodItemDoubleF(
                id = 2,
                imageRes = R.drawable.paneer_samosa_2,
                title = "Paneer Tikka Samosa",
                price = "₹65",
                restaurantName = "Haldiram's",
                rating = "4.7",
                deliveryTime = "15-20 mins",
            ...
            FoodItemDoubleF(
                id = 3,
                imageRes = R.drawable.keema_samosa_3,
                title = "Spicy Keema Samosa",
                price = "₹85",
                restaurantName = "Karim's",
                rating = "4.9",
                deliveryTime = "20-25 mins",
            ...
            FoodItemDoubleF(
                id = 4,
                imageRes = R.drawable.chocolate_samosa_4,
            ...
            FoodItemDoubleF(
                id = 5,
                imageRes = R.drawable.jumbo_samosa_5,
                title = "Jumbo Punjabi Samosa",
                price = "₹120",
            ...
            FoodItemDoubleF(
                id = 6,
                imageRes = R.drawable.vegetable_samosa_6,
                title = "Mixed Vegetable Samosa",
                price = "₹50",
                restaurantName = "Vaishno Dhaba",
                rating = "4.5",
                deliveryTime = "10-15 mins",
                distance = "0.8 km",
                discount = "30%",
...
//            textAlign = TextAlign.Center,
        ...
        // Sample data based on the provided images
        val samosaItemsList = listOf(
            RestaurantItemFull(
                id = 1,
                imageRes = R.drawable.samosa_1,
                title = "Classic Aloo Samosa",
                price = "₹40",
                restaurantName = "Bengal Sweet House",
                rating = "4.8",
            ...
            RestaurantItemFull(
                id = 7,
                imageRes = R.drawable.samosa_7,
                title = "Chicken Seekh Samosa",
                price = "₹95",
                restaurantName = "Al-Bake",
                rating = "4.8",
                deliveryTime = "20-30 mins",
                distance = "1.7 km",
                discount = "12% OFF",
            ...
            RestaurantItemFull(
                id = 8,
                imageRes = R.drawable.samosa_8,
                title = "Cheese & Corn Samosa",
                price = "₹70",
                restaurantName = "Cafe Delhi Heights",
                rating = "4.4",
                deliveryTime = "25-35 mins",
            ...
            RestaurantItemFull(
                id = 9,
                imageRes = R.drawable.samosa_9,
                title = "Air-Fried Healthy Samosa",
                price = "₹60",
            ...
            RestaurantItemFull(
                id = 10,
                imageRes = R.drawable.samosa_10,
                title = "Sindhi Special Samosa",
                price = "₹55",
            ...
            RestaurantItemFull(
                id = 11,
                imageRes = R.drawable.samosa_11,
                title = "Mini Samosa Platter (12 pcs)",
                price = "₹150",
                restaurantName = "Kolkata Sweets",
                rating = "4.5",
                deliveryTime = "20-25 mins",
                distance = "1.8 km",
                discount = "25% OFF",
            ...
            RestaurantItemFull(
                id = 12,
                imageRes = R.drawable.samosa_12,
                title = "Samosa Chaat Special",
                price = "₹80",
            ...
            RestaurantItemFull(
                id = 13,
                imageRes = R.drawable.samosa_13,
                title = "Kashmiri Samosa with Chutney",
                price = "₹90",
                restaurantName = "Ahdoos",
                rating = "4.7",
                deliveryTime = "35-45 mins",
                distance = "2.2 km",
                discount = "20% OFF",
            ...
            RestaurantItemFull(
                id = 14,
                imageRes = R.drawable.samosa_14,
                title = "Spicy Cheese Garlic Samosa",
                price = "₹100",
                restaurantName = "Food Court Express",
                rating = "4.3",
                deliveryTime = "15-25 mins",
                distance = "1.1 km",
                discount = "15% OFF",
            ...
            RestaurantItemFull(
                id = 15,
                imageRes = R.drawable.samosa_15,
                title = "Whole Wheat Healthy Samosa",
                price = "₹45",
                restaurantName = "Health Kitchen",
                rating = "4.6",
                deliveryTime = "20-30 mins",
            ...
            RestaurantItemFull(
                id = 16,
                imageRes = R.drawable.samosa_16,
                title = "Extra Crispy Punjabi Samosa",
                price = "₹55",
                restaurantName = "Punjabi Rasoi",
                rating = "4.8",
                deliveryTime = "25-35 mins",
            ...
            RestaurantItemFull(
                id = 17,
                imageRes = R.drawable.samosa_17,
                title = "Mughlai Chicken Samosa",
                price = "₹110",
                restaurantName = "Nizam's",
                rating = "4.9",
                deliveryTime = "30-40 mins",
                distance = "2.4 km",
                discount = "10% OFF",
            ...
            RestaurantItemFull(
                id = 18,
                imageRes = R.drawable.samosa_18,
                title = "Sweet Mawa Samosa",
                price = "₹85",
            ...
            RestaurantItemFull(
                id = 19,
                imageRes = R.drawable.samosa_19,
                title = "Jain Samosa (No Onion Garlic)",
                price = "₹50",
                restaurantName = "Jain Bhojanalay",
                rating = "4.5",
                deliveryTime = "15-20 mins",
            ...
            RestaurantItemFull(
                id = 20,
                imageRes = R.drawable.samosa_20,
                title = "Butter Samosa with Gravy",
                price = "₹130",
                restaurantName = "Murthal Dhaba",
                rating = "4.8",
                deliveryTime = "40-50 mins",
                distance = "3.0 km",
                discount = "20% OFF",
